...
import styles from "./ResetPasswordEmail1.module.css";
const ResetPasswordEmail1 = () => {
  const navigate = useNavigate();

  const onButtonContainerClick = useCallback(() => {
    navigate("/reset-password-verify-code1");
  }, [navigate]);
  ...
  return (
    <div className={styles.resetPasswordEmail}>
      ...
      <div className={styles.inputedittext}>
        ...
        <img className={styles.iconEmail} alt="" src="/icon--email4.svg" />
        <img className={styles.iconCheck} alt="" src="/icon--check4.svg" />
      </div>
...
export default ResetPasswordEmail1;
