...
import styles from "./SignUpSuccess1.module.css";
  ...
  return (
    <div className={styles.signUpSuccess}>
      ...
      <div className={styles.dontHaveAnAccountSignUpParent}>
        ...
        <div className={styles.inputFields}>
          <div className={styles.termsOfServicePrivacyAgr}>
            ...
            <img className={styles.checkboxIcon} alt="" src="/checkbox2.svg" />
          </div>
          <div className={styles.input}>
            ...
            <img
              ...
              alt=""
              src="/icon--password13.svg"
            />
            <img
              className={styles.iconEyeSlash}
              alt=""
              src="/icon--eye-slash13.svg"
            />
          </div>
          <div className={styles.input1}>
            ...
            <img
              ...
              src="/icon--email7.svg"
            />
            <img className={styles.iconCheck} alt="" src="/icon--check5.svg" />
          </div>
        ...
        <div className={styles.topBar1}>
          <div className={styles.iphoneXstatusBarsstatusBa}>
            ...
            <div className={styles.battery}>
              ...
              <img className={styles.capIcon} alt="" src="/cap7.svg" />
      ...
      <div className={styles.popUp}>
        ...
        <img className={styles.doneIcon} alt="" src="/done5.svg" />
      </div>
    </div>
  );
};

export default SignUpSuccess1;
