...
import styles from "./CreateNewPasswordSuccess1.module.css";
const CreateNewPasswordSuccess1 = () => {
  ...
  return (
    <div className={styles.createNewPasswordSuccess}>
      <div className={styles.keyboard}>
        ...
        <div className={styles.keys}>
          ...
          <div className={styles.shift}>
            ...
            <img className={styles.shiftIcon} alt="" src="/shift4.svg" />
          </div>
      ...
      <div className={styles.inputFields}>
        <div className={styles.input}>
          ...
          <img
            ...
            alt=""
            src="/icon--password8.svg"
          />
          <img
            className={styles.iconEyeSlash}
            alt=""
            src="/icon--eye-slash8.svg"
          />
        </div>
        <div className={styles.input1}>
          ...
          <img
            className={styles.iconEyeSlash}
            alt=""
            src="/icon--eye-slash9.svg"
          />
          <img
            className={styles.iconPassword}
            alt=""
            src="/icon--password9.svg"
          />
        </div>
      </div>
      ...
      <div className={styles.popUp}>
        <img className={styles.doneIcon} alt="" src="/done4.svg" />
...
export default CreateNewPasswordSuccess1;
