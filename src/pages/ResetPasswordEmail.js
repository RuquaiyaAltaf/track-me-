  ...
  return (
    <div className={styles.resetPasswordEmail}>
      ...
      <div className={styles.keyboard}>
        ...
        <div className={styles.keys}>
          ...
          <div className={styles.shift}>
            ...
            <img className={styles.shiftIcon} alt="" src="/shift2.svg" />
          </div>
      ...
      <div className={styles.inputedittext}>
        ...
        <img className={styles.iconEmail} alt="" src="/icon--email1.svg" />
        <img className={styles.iconCheck} alt="" src="/icon--check1.svg" />
      </div>
